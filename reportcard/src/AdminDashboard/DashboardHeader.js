...
import Notifications from './AdminProfile/AdminNotification'
import { useSelector } from "react-redux";
import logoimg from "../static/logowithtext.png"
...
export default function DashboardHeader() {
  ...
  return (
    <>
    <Disclosure as="nav" className="bg-white p-3 mt-2  w-full mb-6 shadow-xl rounded-lg hidden md:block">
      {({ open }) => (
        <>
          <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
            <div className="relative flex h-16 items-center justify-between">
              ...
              <div className="flex space-x-4 capitalize font-semibold text-gray-600 text-xl">
                  <h1>{Admindata.name} ({Admindata.role})</h1>
                  </div>
